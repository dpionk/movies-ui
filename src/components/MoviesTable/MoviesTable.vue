<template>
        ...
        <tr v-for="movie in movies" :key="movie.id">
            ...
            <td>
                <div>
                    ...
                    <button type="button" class="btn btn-danger" @click="toggleConfirmModal(movie.id)">Delete</button>
                </div>
            </td>
        </tr>
    </tbody>
    ...
    <ConfirmModal v-show="showConfirmModal" @onCancel="toggleConfirmModal" @onConfirm="handleConfirm" />
</template>
